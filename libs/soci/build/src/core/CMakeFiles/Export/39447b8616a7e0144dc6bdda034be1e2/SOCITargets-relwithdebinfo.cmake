...
# Import target "SOCI::soci_postgresql" for configuration "RelWithDebInfo"
set_property(TARGET SOCI::soci_postgresql APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)
set_target_properties(SOCI::soci_postgresql PROPERTIES
  IMPORTED_IMPLIB_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/soci_postgresql_4_0.lib"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/soci_postgresql_4_0.dll"
  )
...
# Import target "SOCI::soci_postgresql_static" for configuration "RelWithDebInfo"
set_property(TARGET SOCI::soci_postgresql_static APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)
set_target_properties(SOCI::soci_postgresql_static PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELWITHDEBINFO "CXX"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libsoci_postgresql_4_0.lib"
  )
